...
export const metadata: Metadata = {
  title: "Cojocaru David - Blog",
  metadataBase: new URL("https://cojocarudavid.me/blog"),
  description: "Read latest stories from Cojocaru David's Blog",
  openGraph: {
    title: "Cojocaru David - Blog",
    url: "https://cojocarudavid.me/blog",
    description: "Read latest stories from Cojocaru David's Blog",
    images:
